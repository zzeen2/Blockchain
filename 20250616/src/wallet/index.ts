import { randomBytes } from "crypto"; // 난수만들떄 사용 ( 개인키에서 )
import { Iwallet } from "../interface/wallet.interface"; // Wallet 클래스가 구현해야 할 속성과 메서드의 타입을 정의
...
export class Wallet implements Iwallet {
    ...
    privateKey: string; // 개인키 랜덤한 정수 
    publicKey: string; // 공개키
    balance: number; // 지갑에 표현될 잔액 UTXO에서 가져온다
